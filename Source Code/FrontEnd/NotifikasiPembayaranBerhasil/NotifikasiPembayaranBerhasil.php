...
<head>
  ...
  <!-- File Style CSS -->
  <link rel="stylesheet" href="NotifikasiPembayaranBerhasil.css" />
  <title>Selamat! Anda Telah Berhasil Melakukan Transaksi</title>
</head>
...
<body>
  ...
  <div id="Konten">
    <center>
      <form action="">
        <!-- Bagian Untuk Background Paling Belakang(Ukuran Background Yang Besar) -->
        <div id="Deskripsi">
          <!-- Bagian Notifikasi -->
          <div class="h-35 d-inline-block" id="IsiDeskripsi">
          ...
          <div class="row g-3">
            <!-- Bagian Button Selesai -->
            <div class="col">
              <a href="../CariTiket/CariTiket.php" class="btn btn-warning btn-lg enable" tabindex="-1" role="button"
                aria-disabled="true" id="TombolSelesai">
                Selesai
              </a>
            </div>
