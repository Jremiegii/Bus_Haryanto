                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page"
                                href="../Laporan/Laporan.php"> Laporan </a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php if(isset($_POST['edit'])){ ?>
    <?php
                ...
                if (mysqli_query($conn, $sql)) {
                    echo '<script language="javascript">swal("Berhasil Edit!","","success").then(() => { window.location ="../Laporan/Laporan.php"; });</script>';
                } else {
                    echo '<script language="javascript">swal("Opss!","Data Anda belum berhasil terubah, Mohon Periksa Kembali!","error").then(() => { window.location ="../Laporan/Laporan.php"; });</script>' . mysqli_error($conn);
                }
